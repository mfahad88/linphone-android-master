...
import org.vokka.notifications.NotificationsManager;
...
import org.vokka.utils.PushNotificationUtils;
...
public class LinphoneContext {
    ...
    private void dumpLinphoneInformation() {
        ...
        Log.i("VERSION NAME=" + org.vokka.BuildConfig.VERSION_NAME);
        Log.i("VERSION CODE=" + org.vokka.BuildConfig.VERSION_CODE);
        Log.i("PACKAGE=" + org.vokka.BuildConfig.APPLICATION_ID);
        Log.i("BUILD TYPE=" + org.vokka.BuildConfig.BUILD_TYPE);
