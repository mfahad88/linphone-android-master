...
import org.vokka.call.AndroidAudioManager;
import org.vokka.call.CallManager;
...
import org.vokka.utils.MediaScanner;
...
public class LinphoneManager implements SensorEventListener {
    ...
    private synchronized void configureCore() {
        ...
        String androidVersion = org.vokka.BuildConfig.VERSION_NAME;
